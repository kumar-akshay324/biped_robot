...
#-------------------------------------------------------------------------
	...
	def right_knee_pitch(self, angle_r_k_p, current_angle):
		...
		pwm_start = current_angle * 4.722 + 270
		
		pwm_end = angle_r_k_p * 4.722 + 270
		rang = abs((pwm_end - pwm_start)/2)

		return rang, pwm_start
	...
	def right_hip_pitch(self, angle_r_h_p, current_angle):
		...
		pwm_start = current_angle *4.722 + 285
		pwm_end = angle_r_h_p *4.722 + 285
		rang = abs((pwm_end - pwm_start)/2)
	...
	def left_hip_pitch(self, angle_l_h_p, current_angle):
		...
		pwm_start = current_angle *4.722 + 195
		pwm_end = angle_l_h_p *4.722 + 195
		rang = abs((pwm_end - pwm_start)/2)
	...
	def right_hip_roll(self, angle_r_h_r, current_angle):
		...
		pwm_start = current_angle *4.722 + 275
		pwm_end = angle_r_h_r *4.722 + 275
		rang = abs((pwm_end - pwm_start)/2)
	...
	def left_hip_roll(self, angle_l_h_r, current_angle):
		...
		pwm_start = current_angle *4.722 + 255
		pwm_end = angle_l_h_r *4.722 + 255
		rang = abs((pwm_end - pwm_start)/2)
	...
	def left_hip_yaw(self, angle_l_h_y, current_angle):
		...
		pwm_start = current_angle *4.722 + 225
		pwm_end = angle_l_h_y *4.722 + 225
		rang = abs((pwm_end - pwm_start)/2)
	...
	def right_ankle_pitch(self, angle_r_a_p, current_angle):
		...
		pwm_start = current_angle *4.722 + 295
		pwm_end = angle_r_a_p *4.722 + 295
		rang = abs((pwm_end - pwm_start)/2)
